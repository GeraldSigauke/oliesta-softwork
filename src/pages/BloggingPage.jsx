      ...
      <div class="container my-24 px-6 mx-auto">
        ...
        <section class="mb-32 text-gray-800">
          ...
          <div class="flex flex-wrap mb-12">
            ...
            <div class="grow-0 shrink-0 basis-auto w-full lg:w-6/12 lg:pl-6">
              <h3 class="text-2xl font-bold mb-4">
                A strong online presence gives your business the following
                benefits
              </h3>
          ...
          <div class="flex flex-wrap">
            ...
            <div class="grow-0 shrink-0 basis-auto w-full lg:w-6/12 lg:pl-6">
              <h3 class="text-2xl font-bold mb-4">How we Can Help You</h3>
              ...
              <p class="text-gray-500">
                ...
                beautiful, presentable, professionally made website which serves as your business' way to comunicate with the general public. If your website looks good enough, and performs well enough, you will be drowning in a tsunami of new customers and new clients. That is where we come in! Are you still in doubt? Check{' '}
